  ...
  return (
    <div style={{borderRight:"1px solid var(--color-outline-variant)"}} className="relative hidden lg:flex flex-col flex-1 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-10">
          ...
          >
            Wear the&nbsp;
            <span style={{ color: "var(--color-primary)" }}>edition</span>
            {" "}that defines you.
          </h2>
          ...
          >
            A curated fashion marketplace where independent designers and global
            brands come together. Discover, wear, and sell clothing that tells
            your story.
          </p>
